  ...
  async function onSignUpSubmit(e){
    ...
    return(
      <div class="w-full max-w-sm">
            ...
            <input onChange={(e)=>setNik(e.target.value)} type="number" class="shadow appearance-none border rounded-full py-3 px-4 text-xs text-gray-700 font-medium leading-tight focus:outline-none focus:shadow-outline" placeholder="Masukkan NIK" required/>
          </div>
          <div class="mb-4">
            <label class="block text-gray-700 text-xs font-bold mb-2" for="password">
              Nomor Polisi Kendaraan
            </label>
            <input onChange={(e)=>setNopol(e.target.value)} type="text" class="shadow appearance-none border rounded-full py-3 px-4 text-xs text-gray-700 font-medium leading-tight focus:outline-none focus:shadow-outline" placeholder="Masukkan Nopol" required/>
          ...
          <div class="mb-4">
            ...
            <input onChange={(e)=>setPhoneNumber(e.target.value)} type="number" class="shadow appearance-none border rounded-full py-3 px-4 text-xs text-gray-700 font-medium leading-tight focus:outline-none focus:shadow-outline" placeholder="Masukkan No. Hp" required/>
          </div>
