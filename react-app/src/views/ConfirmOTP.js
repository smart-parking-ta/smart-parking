...
function ConfirmOTP() {
  ...
  return (
    <div class="w-full max-w-sm">
      <form
        class="bg-gradient-to-r g-gradient-to-b from-teal-200 to-blue-50 shadow-md rounded px-8 pt-6 pb-8 mb-4"
        onSubmit={onConfirmSubmit}
      >
        <p className="text-black text-sm pb-6 text-xs">
          Masukkan kode yang dikirimkan ke nomor telepon anda
        </p>
        <div class="mb-4">
          <label
          ...
          <input
            ...
            class="shadow appearance-none border rounded-full py-3 px-5 text-xs text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
            id="username"
            type="text"
