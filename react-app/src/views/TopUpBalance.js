      ...
      <div class="w-full max-w-sm">
          <form class="bg-gradient-to-r g-gradient-to-b from-teal-200 to-blue-50 shadow-md rounded px-8 pt-6 pb-8 mb-4" onSubmit={onSignInSubmit}>
            <div class="mb-4">
              ...
              <input onChange={(e)=>setAmount(e.target.value)} type="number" class="shadow appearance-none border rounded-full py-3 px-4 font-medium text-gray-700 text-xs leading-tight focus:outline-none focus:shadow-outline" id="password" placeholder="Masukkan Nominal" required/>
            </div>
