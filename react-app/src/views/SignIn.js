      ...
      >
        <div class="mb-4">
          ...
          <input
            ...
            type="number"
            class="shadow appearance-none border rounded-full py-3 px-2 font-medium text-gray-700 text-xs leading-tight focus:outline-none focus:shadow-outline"
            placeholder="Masukkan No. Hp 62.."
          />
        </div>
